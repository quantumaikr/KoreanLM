...
@dataclass
class DataArguments:
    data_path: str = field(default='korean_data.json', metadata={"help": "Path to the training data."})


@dataclass
class TrainingArguments(transformers.TrainingArguments):
    output_dir: str = field(default='./pretrained', metadata={"help": "Path to the pretrained model output."})
...
def train():
    ...
    trainer = Trainer(model=koreanlm, tokenizer=tokenizer, args=training_args, **data_module)
    trainer.train()
    trainer.save_state()
